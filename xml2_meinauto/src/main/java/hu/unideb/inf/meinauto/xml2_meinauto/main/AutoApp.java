...
public class AutoApp extends Application {
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach("/autolist?marka={marka}", AutoListResource.class);
        router.attach("/autobylink/{marka}/neuwagen/{tipus}/angebote/{altipus}",AutoByLinkResource.class);
        router.attach("/{marka}/neuwagen/{tipus}/angebote/{altipus}",AutoByLinkResource.class);
